...
class UDF_Flow_Creator(Function):
    ...
    def create_connections(self, parentFunction, childFunction,input_output_params=None,functionRank=None):
        ...
        connectedfunction = Function('connector_'+str(self.connector_rank),tempfunction.function,tempfunction.functionParameters)
        connectedfunction.parent = parentFunction

        self.flow_dict['connector_'+str(self.connector_rank)] = connectedfunction
        ...
        self.flow_dict['connector_'+str(self.connector_rank)].functionParameters = {**self.flow_dict['connector_'+str(self.connector_rank)].functionParameters, **connections}
        return self.flow_dict['connector_'+str(self.connector_rank)]
